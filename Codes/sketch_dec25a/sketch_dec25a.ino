...
const int threshold = 100;  // Buzzer will turn on if the scaled value exceeds 100
...
bool pirEnabled = true;    // Flag to control PIR sensor functionality
...
void setup() {
  ...
  Serial.println("System started. Monitoring motion and air quality...");
...
void loop() {
  ...
  // Scale the MQ135 value from 1-1000 to 1-100
  scaledGasValue = map(mq135Value, 0, 900, 0, 100);
